...
public:
    ...
    void show_meminfo(MemoryCollection memoryCollection){
        ...
        cout<<"************************************"<<endl;
        for (auto iter = memoryCollection.info().begin(); iter != memoryCollection.info().end(); iter++) {
            cout<<"第"<<iter-memoryCollection.info().begin()+1<<"个Memory Device的信息为："<<endl;

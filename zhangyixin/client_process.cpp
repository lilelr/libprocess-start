...
//        });
//
//        install<File>(&Client::report_from_server, &File::process_id);
//
//
//
////        cout<<"pinf"<<endl;
...
//
//        File file;
//        string c_id = this->self();
//        string string_file = test_read_a_file();
//        file.set_process_id(c_id);
//        //file.set_filename();
//        file.set_filevalue(string_file);
//        send(server,file);
//    }
//
...
//          ifstream myfile("/home/zyx/project/libprocess-start/zhangyixin/proto/program/HelloWorld.jar",ios_base::in);

...
set(PROTOBUF_ROOT            ${CMAKE_BINARY_DIR}/thirdparty/protobuf-2.6.1.1)
...
set(PROTOBUF_CONFIGURE       cd ${PROTOBUF_ROOT}/src/protobuf-2.6.1.1 && ./configure --prefix=${PROTOBUF_ROOT})
set(PROTOBUF_MAKE            cd ${PROTOBUF_ROOT}/src/protobuf-2.6.1.1 && make)
set(PROTOBUF_INSTALL         cd ${PROTOBUF_ROOT}/src/protobuf-2.6.1.1 && make install)
